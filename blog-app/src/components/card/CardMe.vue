<template>
  <el-card>
    <h1 class="me-author-name">胡丑丑</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;北京</span>
      <span><i class="me-icon-job"></i> &nbsp;服务端开发者</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1980341227'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/431459931">https://space.bilibili.com/431459931</a>'
        }
      }
    },
    methods: {
